...
# retrieve the model
gp = joblib.load('models/hadronic_energy_estimator.pkl')
...
recoemu_official = root2array('../../../svm/no_truecc_cut_stride2_offset1.root', branches='recoemu',
                              selection='mustopz<1275&&isnumucc==1',
                              step=scaledown)
trueenu = root2array('../../../svm/no_truecc_cut_stride2_offset1.root', branches='trueenu',
                     selection='mustopz<1275&&isnumucc==1',
                     step=scaledown)
ytest = trueenu - recoemu_official
yofftest = root2array('../../../svm/no_truecc_cut_stride2_offset1.root', branches='recoehad',
                      selection='mustopz<1275&&isnumucc==1',
                      step=scaledown)
...
toutf = TFile('output_root_files/hadronic_resolution_step{}.root'.format(scaledown), 'recreate')
