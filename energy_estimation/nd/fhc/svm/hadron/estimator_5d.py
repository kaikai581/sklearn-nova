...
modelpn = 'models/hadronic_5d_energy_estimator_active_c{}g{}step{}.pkl'.format(Cpar, gpar, scaledown)
...
toutf = TFile('output_root_files/resolution_5d_c{}g{}step{}.root'.format(Cpar, gpar, scaledown), 'recreate')
...
with open('performance_figures/5d_c{}g{}step{}.txt'.format(Cpar, gpar, scaledown), 'w') as outf:
