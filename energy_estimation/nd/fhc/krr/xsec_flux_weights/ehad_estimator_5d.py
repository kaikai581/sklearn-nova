...
Five predictors are used, namely, calibrated hadronic energy,
...
def fit_with_subdata(apar, gpar_opt, scaledown, offset):
  ...
  joblib.dump(scaler, 'models/5d/sample_weighted_hadronic_5d_scaler_a{}g{}step{}offset{}.pkl'.format(apar, gpar, scaledown, offset))
  ...
  # save the model
  modelpn = 'models/5d/sample_weighted_hadronic_5d_energy_estimator_a{}g{}step{}offset{}.pkl'.format(apar, gpar, scaledown, offset)
  ...
  toutf = TFile('output_root_files/5d/sample_weighted_resolution_5d_a{}g{}step{}offset{}.root'.format(apar, gpar, scaledown, offset), 'recreate')
  ...
  with open('performance_figures/5d/sample_weighted_5d_a{}g{}step{}offset{}.txt'.format(apar, gpar, scaledown, offset), 'w') as outf:
