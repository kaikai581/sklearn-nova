...
and CVN final state paricle score for proton, neutron, pi0, and charged pi.
"""
...
def fit_with_subdata(apar, gpar_opt, scaledown, offset):
  ...
  #~ plt.savefig('plots/6d/sample_weighted_estimator_overlaid_on_data_{}_a{}g{}step{}offset{}.pdf'.format(var, apar, gpar, scaledown, offset))
